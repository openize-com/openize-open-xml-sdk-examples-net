...
namespace Openize.Words.Examples
{
    ...
    {
        private const string docsDirectory = "../../../Documents/Word/Paragraph/Indent";
        /// <summary>
        ...
        public void CreateIndent(string documentDirectory = docsDirectory, string filename = "WordParagraphsIndented.docx")
        {
            try
            {
                ...
                Openize.Words.IElements.Paragraph para1 = new Openize.Words.IElements.Paragraph();
                ...
                Openize.Words.IElements.Paragraph para2 = new Openize.Words.IElements.Paragraph();
                ...
                Openize.Words.IElements.Paragraph para3 = new Openize.Words.IElements.Paragraph();
                ...
                Openize.Words.IElements.Paragraph para4 = new Openize.Words.IElements.Paragraph();
